...
<div style="
    ...
    font-size: 12px;">
<b>Legend</b><br>
<span style="display:inline-block;width:22px;height:3px;background:red;margin-right:6px;border-top:3px dashed red;"></span> Flight<br>
<span style="display:inline-block;width:22px;height:3px;background:blue;margin-right:6px;"></span> Train<br>
<span style="display:inline-block;width:12px;height:12px;background:green;display:inline-block;margin-right:6px;border:1px solid #333;"></span> City with hotel info
</div>
    
            <div class="folium-map" id="map_cbd1e319c1025e4352f587f07841303d" ></div>
